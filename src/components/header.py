...
def header_home():
    ...
    st.markdown(f"""
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; gap:10px; margin-bottom:16px; margin-top:8px">
            <img src="{logo_url}" style="height:80px; border-radius:16px; box-shadow:0 4px 14px rgba(37,99,235,0.15);">
...
def header_dashboard():
    logo_url = "https://i.ibb.co/0jpP8MjJ/Speak-Wise-Logo-front.png"
    st.markdown(f"""
        <div style="display:flex; align-items:center; justify-content:center; gap:14px; padding:4px 0 12px 0;">
